...
- **Architecture/data details** — `specs/001-user-landing-page/data-model.md`, `contracts/`
...
These drafts are grounded in the actual codebase (Next.js 15 web app, Expo mobile app,
Firebase backend, the member dashboard feature, and the reader-privacy security rules).
Budget figures are **placeholders only** and must be finalized before submission.
